...
export const ImplementsIdea = async () => {
  ...
  return (
    <section className="relative overflow-hidden mt-20 md:mt-30 xl:mt-34 2xl:mt-41">
      <div className="absolute inset-0 pointer-events-none overflow-hidden z-0  xl:mb-1">
        <Image
          alt="decor"
          width={320}
          height={260}
      ...
      <div className="relative z-10">
        <GlassCard radius={0} blur={0.1} className="block w-full">
          <div className="flex flex-col items-center w-full gap-4 xl:gap-5 py-44.5 md:py-30 lg:py-25">
            <h3 className="font-semibold text-32 lg:text-48 2xl:text-64 uppercase text-center leading-tight">
              {t("timeToImplement")}
            </h3>
